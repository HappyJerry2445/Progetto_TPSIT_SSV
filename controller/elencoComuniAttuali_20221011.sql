...
INSERT INTO Cities(code, name, prov) VALUES
('A001',	'ABANO TERME',	'PD'),
...
('E821',	'MAGNANO',	'BI'),
('E825',	'MAGOMADAS',	'OR'),
('E829',	'MAGRE\' SULLA STRADA DEL VINO',	'BZ'),
('E830',	'MAGREGLIO',	'CO'),
('E833',	'MAJANO',	'UD'),
('E834',	'MAIDA',	'CZ'),
('E835',	'MAIERA\'',	'CS'),
...
('H716',	'SALMOUR',	'CN'),
('H717',	'SALO\'',	'BS'),
('H719',	'SALORNO SULLA STRADA DEL VINO',	'BZ'),
...
CREATE TABLE IF NOT EXISTS Patients (
	...
	cityborn INT	NOT NULL,
	gender ENUM('m', 'f')	NOT NULL DEFAULT 'm',
	cf CHAR(16)	NOT NULL UNIQUE,
	password VARCHAR(24)	NOT NULL,
	FOREIGN KEY (cityborn) REFERENCES Cities(id)
);
...
DROP TABLE IF EXISTS Patients_Illness;
CREATE TABLE IF NOT EXISTS Patients_Illness (
	patient_fk INT	NOT NULL,
	illness_fk INT	NOT NULL,
	FOREIGN KEY (patient_fk)	REFERENCES Patients(id),
	FOREIGN KEY (illness_fk)	REFERENCES Illness(id)
);