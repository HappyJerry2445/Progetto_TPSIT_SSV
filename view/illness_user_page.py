...
class Illness_User_Page(tk.Frame):
 ...
 / /___ 
< <(___)
 \_\  """,command=lambda : self._clean(),fg="#000000",bg="#D2D2D2")
        ...
        self.illness_button=tk.Button(self,text="Mostra malattie",command=lambda : self.user_illness_show(),fg="#000000",bg="#D2D2D2")
    ...
    def _clean(self):
            self.illness_list.delete(0,tk.END)
