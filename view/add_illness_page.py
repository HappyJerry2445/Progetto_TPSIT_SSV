...
< <(___)
 \_\    """,command=lambda : controller.show_frame("User_Page"))
        ...
        self.description_illness_label=tk.Label(self,text="Descrizione patologia",font=("Helvetica",15))
        self.illness_label.place(x=250,y=200)
        self.illness_input=tk.Entry(self)
        self.illness_input.place(x=300,y=230)

        #add illness button
        self.add_illness_button=tk.Button(self,text="Aggiungi patologia")
        self.add_illness_button.place(x=300,y=350)
